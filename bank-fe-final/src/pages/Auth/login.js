...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('userId', newResponse.userId);
      localStorage.setItem('username', newResponse.username);
      localStorage.setItem('accountId', newResponse.accountId);

      console.log("Token:", newResponse.token);
      console.log("UserId:", newResponse.userId);
      console.log("Username:", newResponse.username);
      console.log("AccountId:", newResponse.accountId);
