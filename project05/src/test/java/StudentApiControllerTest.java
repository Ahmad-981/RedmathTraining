...
//                .andExpect(MockMvcResultMatchers.jsonPath("$.at", Matchers.notNullValue()));
    ...
    @Test
    @WithMockUser(roles = "admin", username = "admin", password = "{bcrypt}$2a$12$diheMtyeAeA8iBeVx.prq.jeVWuRWrtmlnAwcS7bbLbEJp/EtulPW")
    public void testDeleteStudent() throws Exception {
        Long studentId = 1L;

        // Perform DELETE request
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/student/1", studentId))
                .andExpect(MockMvcResultMatchers.status().isOk())
