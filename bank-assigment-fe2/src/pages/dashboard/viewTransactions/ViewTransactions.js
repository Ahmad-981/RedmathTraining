...
function ViewTransactions() {
  ...
  // Replace with your logged-in account ID logic
  const accountId = 1;
  ...
  const fetchTransactions = async () => {
    try {
      const response = await axios.get(`http://localhost:8080/api/transaction/by-account?id=${accountId}`, {
        headers: {
            ...
            : <>
              {transactions.length < 1
                ? <div className='text-center my-5'>
                  <p>We don't have any transactions yet!</p>
